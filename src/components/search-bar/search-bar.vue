...
import { formmatMonthDay } from "@/utils/fomat_data";
...
const startDateStr = computed(() => formmatMonthDay(startDate.value, "MM.DD"));
const endDateStr = computed(() => formmatMonthDay(endDate.value, "MM.DD"));
</script>
